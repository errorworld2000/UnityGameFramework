...
using GameFramework.Scene.Args;
using System;
...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class SceneComponent : UnityGameFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_GameFrameworkScene = SceneManager.GetSceneAt(UnityGameFrameworkEntry.GameFrameworkSceneId);
