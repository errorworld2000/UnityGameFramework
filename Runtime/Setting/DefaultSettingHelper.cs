...
namespace UnityGameFramework.Runtime
{
    ...
    public class DefaultSettingHelper : SettingHelperBase
    {
        ...
        public virtual string FilePath
        {
            get
            {
                return GameFramework.Utility.Path.GetRegularPath(System.IO.Path.Combine(Application.persistentDataPath, SettingFileName));
            }
        }
        ...
        {
            return Json.ToObject<T>(GetString(settingName));
        }
        ...
        {
            return Json.ToObject(objectType, GetString(settingName));
        }
        ...
        public override object GetObject(Type objectType, string settingName, object defaultObj)
        {
            ...
            return Json.ToObject(objectType, json);
        }
        ...
        {
            SetString(settingName, Json.ToJson(obj));
        }
