...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class ItemComponent : UnityGameFrameworkComponent
    {
        ...
        public bool AddItemGroup(string itemGroupName, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority)
        {
            ...
            itemGroupHelper.name = string.Format("Item Group - {0}", itemGroupName);
        ...
        private void OnShowItemSuccess(object sender, ShowItemSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ShowItemSuccessEventArgs.Create(e));
        }

        private void OnShowItemFailure(object sender, ShowItemFailureEventArgs e)
        {
        ...
        private void OnShowItemUpdate(object sender, ShowItemUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, ShowItemUpdateEventArgs.Create(e));
        }

        private void OnShowItemDependencyAsset(object sender, ShowItemDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, ShowItemDependencyAssetEventArgs.Create(e));
        }

        private void OnHideItemComplete(object sender, HideItemCompleteEventArgs e)
        {
