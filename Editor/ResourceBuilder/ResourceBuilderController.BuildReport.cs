    ...
    public sealed partial class ResourceBuilderController
    {
        private sealed class BuildReport
        {
                ...
                Platform platforms, bool zipSelected, int buildAssetBundleOptions, SortedDictionary<string, ResourceData> resourceDatas)
            {
                ...
                m_BuildReportName = GameFramework.Utility.Path.GetRegularPath(Path.Combine(buildReportPath, BuildReportName));
                m_BuildLogName = GameFramework.Utility.Path.GetRegularPath(Path.Combine(buildReportPath, BuildLogName));
