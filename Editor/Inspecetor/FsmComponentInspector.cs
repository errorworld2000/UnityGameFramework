...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class FsmComponentInspector : GameFrameworkInspector
    {
        ...
        {
            EditorGUILayout.LabelField(fsm.FullName, fsm.IsRunning ? string.Format("{0}, {1} s", fsm.CurrentStateName, fsm.CurrentStateTime.ToString("F1")) : (fsm.IsDestroyed ? "Destroyed" : "Not Running"));
        }
    }
}