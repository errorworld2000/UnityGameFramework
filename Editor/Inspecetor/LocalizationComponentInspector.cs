...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class LocalizationComponentInspector : GameFrameworkInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.PropertyField(m_EnableLoadDictionaryUpdateEvent, new GUIContent("Enable Load Dictionary Update Event"));
                EditorGUILayout.PropertyField(m_EnableLoadDictionaryDependencyAssetEvent, new GUIContent("Enable Load Dictionary Dependency Asset Event"));
