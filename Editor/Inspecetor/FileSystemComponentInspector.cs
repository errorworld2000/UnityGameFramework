...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class FileSystemComponentInspector : GameFrameworkInspector
    {
        ...
        {
            EditorGUILayout.LabelField(fileSystem.FullPath, string.Format("{0}, {1} / {2} Files", fileSystem.Access.ToString(), fileSystem.FileCount.ToString(), fileSystem.MaxFileCount.ToString()));
        }
    }
}
